...
export class MenuInputComponent implements OnInit {
  menu: Menu;
  categoriesList: String[] = ["Appetizer", "Lunch Special", "Dinner Special", "Tempura", "Noodles", "Ramen", "Japanese Curry", "Sashimi", "Sushi Nigiri", "Hoso Maki", "Temaki (Sushi Cones)", "Vegetable Sushi Rolls", "Sushi Rolls", "Baked Rolls", "Tempura Rolls", "Chef's Special Rolls", "Teriyaki / Katsu / Don", "Roll Combo", "Platter"];
